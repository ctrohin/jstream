...
def isEmptyOrNone(
    obj: list[Any] | dict[Any, Any] | str | None | Any | Iterable[Any],
) -> bool: ...
def cmpToKey(mycmp: Callable[[C, C], int]) -> type: ...
def each(target: Iterable[T] | None, action: Callable[[T], Any]) -> None: ...
def findFirst(
    target: Iterable[T] | None, predicate: Callable[[T], bool]
) -> T | None: ...
...
class _GenericIterable(
    ABC, Iterator[T], Iterable[T], Generic[T], metaclass=abc.ABCMeta
):
